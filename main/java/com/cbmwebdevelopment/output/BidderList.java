...
public class BidderList {
	...
	public BidderList(String auctionId) {
	...
	private void createExcel(FileOutputStream fileOut, ByteArrayOutputStream output) throws IOException {
		...
		row.createCell(5).setCellValue("Suite/Apartment");
		row.createCell(6).setCellValue("City");
		row.createCell(7).setCellValue("State");
		row.createCell(8).setCellValue("Postal Code");
		bidder = new Bidder();
		bidder.getAuctionBidders(this.auctionId).forEach((key, value) -> {
			...
			row.createCell(6).setCellValue(value.get(5));
			row.createCell(7).setCellValue(value.get(6));
			row.createCell(8).setCellValue(value.get(7));
			rowNum++;
		});
	 ...
	 *
	 */
	public void exportBiddersToExcel() {
		// Instantiate the workbook

		FileChooser fileChooser = new FileChooser();
		fileChooser.setTitle("Export Table To");
		fileChooser.setInitialDirectory(new File(Values.USER_HOME + "/Documents"));
		fileChooser.setInitialFileName("Bidders.xls");
